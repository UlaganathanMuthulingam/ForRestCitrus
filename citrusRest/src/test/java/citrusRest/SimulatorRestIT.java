...
public class SimulatorRestIT extends TestNGCitrusTestDesigner {
    ...
    public void testHelloRequest() {
        ...
        http().client(simulatorClient)
                ...
                .payload("<HelloUlaganathan xmlns=\"http://citrusframework.org/schemas/hello\">" +
                            "Hi there!" +
                         "</HelloUlaganathan>");
    }
    ...
    public void testnewElement()
    {
    	...
    	.send()
    	.post("goodda")
    	.payload("<Goodda xmlns=\"http://citrusframework.org/schemas/hello\">" +
                "dai" +
            "</Goodda>");
